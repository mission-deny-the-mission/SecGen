...
- [ ] 2.1 Define the external harness adapter contract for plan, generate, validate, test, repair, report, and stop conditions.
- [ ] 2.2 Verify OpenCode noninteractive invocation, model/provider configuration, staged workspace support, logs/transcripts, and CI suitability.
...
- [ ] 3.1 Define the approved vulnerable software template metadata format, including vulnerability class, platform support, parameters, required files, flags, and test expectations.
