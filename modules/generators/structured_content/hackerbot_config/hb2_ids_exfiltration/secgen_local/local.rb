...
class HB2IDSExfiltration < HackerbotConfigGenerator
  ...
  def initialize
    super
    self.module_name = 'Hackerbot 2 Config Generator IDS Exfiltration'
    self.title = 'IDS Exfiltration Detection'
